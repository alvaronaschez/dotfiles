...
# e is for edit
alias ezsh="nv ~/.zshrc"
alias ealiases="nv ~/.config/oh-my-zsh/custom/aliases.zsh"
alias eal=ealiases
alias esway="nv ~/.config/sway/config"
alias efoot="nv ~/.config/foot/foot.ini"
alias evim="nv ~/.vimrc"
alias envim="nv ~/.config/nvim/init.lua"
alias etmux="nv ~/.config/tmux/tmux.conf"
alias egit="nv ~/.config/git/config"
alias eranger="nv ~/.config/ranger/rifle.conf"
alias eneofetch="nv ~/.config/neofetch/config.conf"
